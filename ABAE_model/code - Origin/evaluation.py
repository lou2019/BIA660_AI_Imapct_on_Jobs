...
def evaluation(true, predict, domain):
    ...
    if domain == 'restaurant': # domain???
        ...
        print(classification_report(true_label, predict_label,
                                    ['Food', 'Staff', 'Ambience', 'Anecdotes', 'Price', 'Miscellaneous'], digits=3)) # 这里需要修改成我想要的
...
topic_weight_out = open(out_dir + '/topic_weights', 'wt', encoding='utf-8') # 创建topic_weight_out
labels_out = open(out_dir + '/labels.txt', 'wt', encoding='utf-8') # 创建prediction label
