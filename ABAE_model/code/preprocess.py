...
def preprocess_train(domain): # 读取数据 for training
    f = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/datasets/' + domain + '/train.txt', 'r')
    out = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/preprocessed_data/' + domain + '/train.txt', 'w', 'utf-8')
...
def preprocess_test(domain): # 这里是需要修改的部分, 我们没有dataset
    ...
    f1 = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/datasets/' + domain + '/test.txt', 'rb', 'utf-8')
    f2 = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/datasets/' + domain + '/test_label.txt', 'rb', 'utf-8')
    out1 = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/preprocessed_data/' + domain + '/test.txt', 'w', 'utf-8')
    out2 = codecs.open('/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/preprocessed_data/' + domain + '/test_label.txt', 'w', 'utf-8')
...
def preprocess_reviews_train(): # review 不一定会运行. 除非特定的名字叫app_reviews
    with open("/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/preprocessed_data/app_reviews/appstore.json", "rt") as f:
        reviews = json.load(f)
    with open("/content/drive/My Drive/Attention-Based-Aspect-Extraction-master/preprocessed_data/app_reviews/train.txt", "wt") as f:
