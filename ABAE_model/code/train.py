...
parser.add_argument("--emb-name",  type=str,
                    help="The name to the word embeddings file", default="res_w2v_embedding")
...
model.get_layer('word_emb').trainable = False   # 改变model参数? 这里怎么提取的
